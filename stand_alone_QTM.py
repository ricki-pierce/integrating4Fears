#Do NOT change anything about this code! This is the basic example for how I can get QTM to automatically save and reset
# This is a "stand alone" sample code that is to be run when QTM is already open on the computer. 
# This is the right combination of commands that start the recording, stop the recording, saves the recording, and resets QTM to begin a new recording. 

...
async def start_recording_and_trial():
    ...
    # --- Start Neon recording if connected ---
    if neon_device:
        try:
            # Log command sent
            event_log.append((
            ...
            print(f"{measurement_name}: Neon Start Command Sent")

            # Run Neon recording in a separate thread so GUI/loop isn't blocked
            ...
            print(f"{measurement_name}: Neon Recording Started")
    ...
    async def stop_neon_recording():
        if neon_device:
            try:
                ...
                print(f"{task_name}_Trial{trial_number}: Neon Stop Command Sent")
                ...
                print(f"{task_name}_Trial{trial_number}: Neon Recording Stopped")
